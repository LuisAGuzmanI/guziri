...
public class PatitoParserParser extends Parser {
	...
	public final AsignaContext asigna() throws RecognitionException {
		...
		try {
			...
			this.OperatorStack.push((((AsignaContext)_localctx).ASSIGN!=null?((AsignaContext)_localctx).ASSIGN.getText():null)) // Semantic action #2.2} expresion {
	...
	public final ExpresionContext expresion() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				this.OperatorStack.push((((ExpresionContext)_localctx).comparador!=null?_input.getText(((ExpresionContext)_localctx).comparador.start,((ExpresionContext)_localctx).comparador.stop):null)); // Semantic action #2.10} exp {
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			case LPAR:
				...
				this.OperatorStack.push((((FactorContext)_localctx).LPAR!=null?((FactorContext)_localctx).LPAR.getText():null)); // Semantic action #2.8} expresion {
							// Semantic action #2.9
							if(this.OperatorStack.top() == "("){
